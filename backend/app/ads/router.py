...
from app.ads.templates.pixel_snippet import generate_pixel_snippet
...
async def pause_campaign_action(
    ...
    try:
        ...
        from app.ads.meta_ads_client import pause_campaign
...
async def resume_campaign_action(
    ...
    try:
        service = AdService(db)
        config = await service.get_campaign_config(tenant_id, config_id)
        from app.ads.meta_ads_client import resume_campaign
