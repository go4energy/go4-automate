  ...
  <div class="mx-auto max-w-3xl">
    ...
    <form v-else class="mt-8 space-y-6" @submit.prevent="save">
      <div class="rounded-lg bg-white dark:bg-gray-800 p-6 shadow-sm">
        <h2 class="mb-4 text-lg font-medium text-go4-secondary dark:text-gray-100">Grunddaten</h2>
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            <label class="block text-sm font-medium text-go4-muted dark:text-gray-400"
              >Meta Campaign ID</label
            >
            <input
      ...
      <div class="rounded-lg bg-white dark:bg-gray-800 p-6 shadow-sm">
        <h2 class="mb-4 text-lg font-medium text-go4-secondary dark:text-gray-100">Budget & CPL</h2>
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            <label class="block text-sm font-medium text-go4-muted dark:text-gray-400"
              >Ziel-CPL (EUR)</label
      ...
      <div class="rounded-lg bg-white dark:bg-gray-800 p-6 shadow-sm">
        <h2 class="mb-4 text-lg font-medium text-go4-secondary dark:text-gray-100">Optimierung</h2>
        <div class="space-y-4">
          <label class="flex items-center gap-3">
            ...
            />
            <span class="text-sm text-go4-secondary dark:text-gray-100"
              >Automatische Budget-Optimierung</span
            >
          </label>
          <label class="flex items-center gap-3">
            <input
