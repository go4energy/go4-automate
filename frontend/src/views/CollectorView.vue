...
const activeTab = useTabState('collector', 'sources', ['sources', 'findings', 'prompts', 'topics'])
...
<template>
  <div>
    ...
    <div class="mt-4 flex items-center gap-2 flex-wrap">
      ...
      <!-- Group settings -->
      <div v-if="store.activeGroup" class="relative ml-1">
        <button
    ...
    <div v-else-if="activeTab === 'topics'" class="mt-6">
      ...
      <template v-else>
        ...
        <div class="mb-3 flex items-center justify-between">
          <div v-if="selectedTopicIds.size > 0" class="flex items-center gap-3">
    ...
    <!-- ==================== Prompts Tab ==================== -->
    <div v-else-if="activeTab === 'prompts'" class="mt-6">
      <!-- Loading -->
      <div v-if="promptsLoading" class="flex items-center justify-center py-12">
    ...
    <div v-else-if="activeTab === 'findings'" class="mt-6">
      ...
      <template v-else>
        <!-- Toolbar: bulk actions + filter -->
        <div class="mb-3 flex items-center justify-between">
          <div v-if="selectedFindingIds.size > 0" class="flex items-center gap-3">
            <span class="text-sm font-medium text-go4-secondary dark:text-gray-100">
    ...
    >
      <div class="w-full max-w-md rounded-lg bg-white dark:bg-gray-800 p-6 shadow-xl">
        ...
        <form class="mt-4 space-y-4" @submit.prevent="handleGroupSubmit">
          <div>
    ...
    >
      <div class="w-full max-w-md rounded-lg bg-white dark:bg-gray-800 p-6 shadow-xl">
        ...
        <p v-if="duplicateSourceSlug" class="mt-1 text-xs text-go4-muted dark:text-gray-400">
        ...
        <form class="mt-4 space-y-4" @submit.prevent="handleAddPrompt">
          <div>
            <label class="block text-sm font-medium text-go4-secondary dark:text-gray-100">
              Zweck
            </label>
