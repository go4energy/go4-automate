...
<template>
  <div
    class="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#E8EDFF] via-[#DED8FF] to-[#FFE8D8] px-4 dark:from-[#0A0015] dark:via-[#000A1A] dark:to-[#050510]"
  >
