  ...
  <div>
    ...
    <div v-else class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
      ...
      <div class="space-y-5">
        ...
        <!-- Prompts -->
        <div class="rounded-lg bg-white dark:bg-gray-800 p-5 shadow-sm">
          <h2 class="mb-4 text-sm font-semibold text-go4-secondary dark:text-gray-100">Prompts</h2>
          <div class="space-y-3">
            <div>
              <label class="mb-1 block text-xs font-medium text-go4-muted dark:text-gray-400"
                >System Prompt</label
        ...
        <div class="rounded-lg bg-white dark:bg-gray-800 p-5 shadow-sm">
          <div class="mb-4 flex items-center justify-between">
            <h2 class="text-sm font-semibold text-go4-secondary dark:text-gray-100">Variablen</h2>
            <button
          ...
          <div v-if="form.variables.length === 0" class="text-xs text-go4-muted dark:text-gray-400">
        ...
        <div class="rounded-lg bg-white dark:bg-gray-800 p-5 shadow-sm">
          ...
          <div class="space-y-3">
            ...
            <div>
              <label class="mb-1 block text-xs font-medium text-go4-muted dark:text-gray-400"
                >Verarbeitungsmodus</label
              >
              <select
                v-model="form.processing_mode"
                class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-go4-primary focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
              >
                <option value="batch">Alle Findings auf einmal (batch)</option>
                <option value="each">Pro Finding einzeln (each)</option>
              </select>
      ...
      <div class="space-y-5">
        ...
        <div class="rounded-lg bg-white dark:bg-gray-800 p-5 shadow-sm">
          ...
          <div v-if="!form.slug" class="text-xs text-go4-muted dark:text-gray-400">
        ...
        <div v-if="testResult" class="rounded-lg bg-white dark:bg-gray-800 p-5 shadow-sm">
          <div class="mb-3 flex items-center justify-between">
            <h2 class="text-sm font-semibold text-go4-secondary dark:text-gray-100">Ergebnis</h2>
