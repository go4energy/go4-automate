...
<template>
  <div class="p-6 space-y-4">
    <PageHeader title="Leadgen" subtitle="B2B-Lead-Discovery und Anreicherung" />
    ...
    <EmptyState
      ...
      description="Lege eine Kampagne an um B2B-Leads zu discovern."
    />
    ...
    >
      <table class="w-full text-sm">
        <thead class="bg-gray-50 text-left text-xs uppercase tracking-wide text-gray-600 dark:bg-gray-900/40 dark:text-gray-300">
          <tr>
            <th class="px-4 py-2">Kampagne</th>
            <th class="px-4 py-2">Status</th>
            <th class="px-4 py-2 text-right">Leads</th>
            <th class="px-4 py-2 text-right">Angereichert</th>
            <th class="px-4 py-2">Aktiver Prozess</th>
            <th class="px-4 py-2">Aktualisiert</th>
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
          ...
          >
            ...
            <td class="px-4 py-3">
              <div v-if="c.active_run" class="space-y-1">
                <div class="text-xs">
    ...
    <ConfirmDialog
      ...
      :message="`'${campaignToDelete?.name}' wird unwiderruflich gelöscht. Zugehörige Prospects, Runs und Insights bleiben erhalten, sind aber ohne Kampagnen-Bezug.`"
